...
key = 'e81f069dd11a3d0de4e29facc48edb79'

API_CALL = ('https://api.openweathermap.org/data/2.5/onecall?'
            'lat=33.441792&lon=-94.037689&exclude=hourly,daily&appid=e81f069dd11a3d0de4e29facc48edb79')

def long_lat():
    try:
        city = input('Digite a city: ')
        domain = ('http://api.openweathermap.org/data/2.5/weather?q=' + city + '&appid=e81f069dd11a3d0de4e29facc48edb79')
...
def date_7_days():
    ...
    lon = str(longi)
    api_call = ('https://api.openweathermap.org/data/2.5/onecall?'
                'lat='+lat+'&lon='+lon+'&exclude=hourly&appid=e81f069dd11a3d0de4e29facc48edb79')
    r = requests.get(api_call)
    parse_json = json.loads(r.text)
    #prev_2_days = parse_json
