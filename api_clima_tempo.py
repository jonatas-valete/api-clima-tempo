...
def weather_today():
    ...
    DOMINIO = ('http://api.openweathermap.org/data/2.5/weather?q=' + cidade + '&appid=de5d763fc253d3738b81b7feceff35d0')
    try:
        ...
        print('{} invália, especifique um nome válido'.format(cidade))
